<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('kategori/aksesoris-and-komputer') ?>">
          <i class="fas fa-fw fa-tv"></i>
          <span>Akesoris & Komputer</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('kategori/pakaian-pria') ?>">
          <i class="fad fa-fw fa-tshirt" style="color: rgb(255, 0, 0)"></i>
          <span>Pakaian Pria</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('kategori/pakaian-wanita') ?>">
          <i class="fad fa-fw fa-tshirt" style="color: rgb(252, 192, 203)"></i>
          <span>Pakaian Wanita</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('kategori/pakaian-anak-anak') ?>">
          <i class="fad fa-fw fa-tshirt" style="color: rgb(249, 0, 255)"></i>
